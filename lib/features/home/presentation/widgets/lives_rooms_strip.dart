...
class LiveRoomsStrip extends StatefulWidget {
  ...
  @override
  State<LiveRoomsStrip> createState() => _LiveRoomsStripState();
}

class _LiveRoomsStripState extends State<LiveRoomsStrip>
        ...
        children: [
          ...
          _RoomRow(
            ...
            avatarColors: [
              ...
              const Color(0xFF0D2219),
              const Color(0xFF2A1F00),
            ],
            avatarLabels: ['AO', 'TF', '+11'],
            actionLabel: 'Return →',
          ...
          _RoomRow(
            ...
            avatarColors: [
              const Color(0xFF0C1E32),
              AppColors.accentSurface,
              const Color(0xFF2A1020),
            ],
            avatarLabels: ['ZN', 'AF', '+5'],
            actionLabel: 'Join →',
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(actionLabel,
            style: AppTextStyles.labelMedium
                .copyWith(color: actionColor, fontSize: 11)),
      ],
    );
  }
}